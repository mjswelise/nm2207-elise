...
Also, my visualisations aren't loading on the website. Still trying to figure that out.

## Final Submission

### 1. What is the theme of your data story?

The theme of this data story revolves around exploring the intricacies of genre classification in the realm of music, leveraging a dataset from Spotify spanning six decades. The study aims to unravel the underlying patterns and relationships between various audio features, ultimately seeking to answer the fundamental question: How does genre classification work, and can genres be classified by solely audio features?

### 2. Why is it important to address this question?

Understanding how genre classification works in the context of music is crucial for several reasons. According to the Recording Industry Association of America (2022), revenues from streaming music grew 26% to $5.9 billion in the first half of 2021, accounting for 84% of total music revenues for the period and a 4% climb from 2019 levels. Spotify is a platform, in particular, has revolutionised music consumption methods - it currently is the "world’s biggest music streaming provider in terms of global paid-for subscriptions" (Music Business Worldwide, 2023), and is projected to retain its dominance "throughout the rest of the 2020s" (Goldman Sachs, 2023). Furthermore, there has been a marked shift from "hard genre categorisation" to "mood-based categorisation" on digital music platforms - this sense of multi-formatting is used to popularising new music through means of exposure (The Guardian, 2017).

As such, examining how music genre categorisation on Spotify works is important as it elucidates the dynamic interplay of change and continuity in the music industry, which can also guide business strategies as well as offer us valuable insights into the ever-evolving music landscape within our increasingly digitalised society.

### 3. Why do you think the data sources that you have curated can help you answer the question?

The curated dataset from Spotify provides a rich source of information, encompassing audio features, genres, and other relevant details of songs spanning a significant time period. By analysing this data, one can discern trends, correlations, and patterns that contribute to the understanding of how specific audio features relate to different genres. The comprehensive nature of the dataset allows for a nuanced exploration of genre classification, considering variables such as energy, danceability, valence, and more.

### 4. What are the insights from the data and how are they depicted in plots?

The data exploration process has unearthed several insights:

Genre-Specific Audio Feature Density: Plots depict the density of audio features by genre, revealing overarching trends and genre-specific characteristics. For instance, EDM tends to feature lower acoustic elements, heightened energy, and subdued valence, while Latin music is characterised by elevated valence and pronounced danceability.

Correlation Analysis: Correlation plots illustrate the relationships between individual audio features and genres. Notable correlations, such as energy and loudness, are identified. The study also explores correlations between specific genres, uncovering differences and similarities.

Quantifiable Genre Categorisation: A novel approach involves defining genres quantifiably by identifying the median values of audio features for each genre. This facilitates a data-driven understanding of the distinctive attributes defining each genre.

Predictive Algorithm Evaluation: The decision tree-based predictive algorithm is implemented to test the feasibility of classifying genres based on audio features. The analysis involves structuring the decision tree, adjusting default classifications, and evaluating the accuracy of genre predictions.
...
Data Wrangling and Exploration: The initial stages focused on cleaning and exploring the dataset, condensing it by year, and filtering out instances with insufficient data. This process revealed overall trends and genre-specific characteristics.

Visualisation: Extensive use of ggplot and Shiny for visualisations allowed for a comprehensive exploration of the data. Density plots, correlation matrices, and genre-specific visualisations aided in conveying complex relationships.

Statistical Analysis: The study incorporated statistical measures such as correlation coefficients to quantify relationships between audio features. The median-based approach for genre categorisation introduced a novel statistical aspect to the analysis.

Predictive Modeling: The decision tree algorithm was implemented for genre classification, considering factors such as energy, popularity, danceability, and valence. Adjustments were made to default classifications based on the dataset's genre distribution.

Throughout the project, the implementation of decision trees for genre classification and the quantifiable genre categorisation approach introduced new concepts, showcasing the dynamic nature of music genre analysis and classification.
...
Tidy Tuesday (2020). Spotify Songs. https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2020/2020-01-21/spotify_songs.csv 
